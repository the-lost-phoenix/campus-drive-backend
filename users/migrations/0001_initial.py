...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('college_id_image', models.ImageField(blank=True, null=True, upload_to='college_ids/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dl_image', models.ImageField(blank=True, null=True, upload_to='dl_scans/')),
                ('is_verified', models.BooleanField(default=False)),
                ('car_model', models.CharField(max_length=100)),
                ('car_image', models.ImageField(blank=True, null=True, upload_to='car_images/')),
                ('hourly_rate', models.DecimalField(decimal_places=2, default=500.0, max_digits=6)),
                ('bio', models.TextField(blank=True, help_text='Tell students about your experience')),
